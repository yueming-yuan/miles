...
class RunArgs(CommonRunArgs):
    ...
    indexer_replay_dump_path: Path | None = _field(default=None, help="Indexer replay dump path")
    indexer_replay_load_path: Path | None = _field(default=None, help="Indexer replay load path")
