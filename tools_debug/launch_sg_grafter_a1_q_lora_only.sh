...
OUTPUT=/storage/yueming/dumper-out/v4-iter59-grafter-a1-q-lora-only-sg
mkdir -p "$OUTPUT"
...
export DUMPER_GRAFTER_T2B_FILTER="${DUMPER_GRAFTER_T2B_FILTER:-name == \"attn_q\" and graft_phase == \"prefill\"}"
